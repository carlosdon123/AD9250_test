...
# ----------------------------------------
# If core_pll is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 203 win32 2018.04.11.15:26:19
...
ensure_lib                           ./libraries/core_pll_altera_iopll_161/
vmap       core_pll_altera_iopll_161 ./libraries/core_pll_altera_iopll_161/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_iopll_161/sim/core_pll_altera_iopll_161_ep46qai.vo" -work core_pll_altera_iopll_161
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/core_pll.v"                                                                                  
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L core_pll_altera_iopll_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L core_pll_altera_iopll_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
