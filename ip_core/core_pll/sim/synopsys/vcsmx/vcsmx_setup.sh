...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_iopll_161/sim/core_pll_altera_iopll_161_ep46qai.vo" -work core_pll_altera_iopll_161
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/core_pll.v"                                                                                  
fi
