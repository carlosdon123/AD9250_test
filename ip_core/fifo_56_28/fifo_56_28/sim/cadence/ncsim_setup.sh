...
mkdir -p ./libraries/fifo_56_28_fifo_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_161/sim/fifo_56_28_fifo_161_jjnbjqy.v" -work fifo_56_28_fifo_161 -cdslib ./cds_libs/fifo_56_28_fifo_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_56_28.v"                                                                                                          
fi
