...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_161/sim/fifo_56_28_fifo_161_jjnbjqy.v" -work fifo_56_28_fifo_161
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_56_28.v"                                                           
fi
