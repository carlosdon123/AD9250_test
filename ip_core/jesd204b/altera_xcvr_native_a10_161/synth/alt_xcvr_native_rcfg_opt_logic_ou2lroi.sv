...
module alt_xcvr_native_rcfg_opt_logic_ou2lroi #(
...
generate if(RCFG_EMB_STRM_ENABLED) begin : g_rcfg_strm_enable //TODO check to see if there is parameter redundancy
      ...
      alt_xcvr_native_rcfg_strm_top_ou2lroi #(
...
assign pcie_dfe_read_write      = split_pcie_dfe_read | split_pcie_dfe_write | pcie_dfe_avmm_lock;
