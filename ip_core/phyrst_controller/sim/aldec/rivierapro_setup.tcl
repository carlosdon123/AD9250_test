...
alias com {
  echo "\[exec\] com"
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_xcvr_reset_control_161/sim/altera_xcvr_functions.sv"     -work phyrst_controller_altera_xcvr_reset_control_161
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_xcvr_reset_control_161/sim/alt_xcvr_resync.sv"           -work phyrst_controller_altera_xcvr_reset_control_161
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_xcvr_reset_control_161/sim/altera_xcvr_reset_control.sv" -work phyrst_controller_altera_xcvr_reset_control_161
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_xcvr_reset_control_161/sim/alt_xcvr_reset_counter.sv"    -work phyrst_controller_altera_xcvr_reset_control_161
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/phyrst_controller.v"                                                                                                    
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L phyrst_controller_altera_xcvr_reset_control_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L phyrst_controller_altera_xcvr_reset_control_161 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
