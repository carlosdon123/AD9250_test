...
TOP_LEVEL_NAME="phyrst_controller"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/phyrst_controller_altera_xcvr_reset_control_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_161/sim/altera_xcvr_functions.sv"     -work phyrst_controller_altera_xcvr_reset_control_161 -cdslib ./cds_libs/phyrst_controller_altera_xcvr_reset_control_161.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_161/sim/alt_xcvr_resync.sv"           -work phyrst_controller_altera_xcvr_reset_control_161 -cdslib ./cds_libs/phyrst_controller_altera_xcvr_reset_control_161.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_161/sim/altera_xcvr_reset_control.sv" -work phyrst_controller_altera_xcvr_reset_control_161 -cdslib ./cds_libs/phyrst_controller_altera_xcvr_reset_control_161.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_161/sim/alt_xcvr_reset_counter.sv"    -work phyrst_controller_altera_xcvr_reset_control_161 -cdslib ./cds_libs/phyrst_controller_altera_xcvr_reset_control_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/phyrst_controller.v"                                                                                                                                                                               
fi
