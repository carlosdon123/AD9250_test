...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../rom_1port_161/sim/rom_port_rom_1port_161_iitz24a.v" -work rom_port_rom_1port_161 -cdslib ./cds_libs/rom_port_rom_1port_161.cds.lib
