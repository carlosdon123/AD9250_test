...
TOP_LEVEL_NAME="tb_tx_phyrst_ctl"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/tb_tx_phyrst_ctl_altera_xcvr_reset_control_161/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_161/sim/altera_xcvr_functions.sv"     -work tb_tx_phyrst_ctl_altera_xcvr_reset_control_161 -cdslib ./cds_libs/tb_tx_phyrst_ctl_altera_xcvr_reset_control_161.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_161/sim/alt_xcvr_resync.sv"           -work tb_tx_phyrst_ctl_altera_xcvr_reset_control_161 -cdslib ./cds_libs/tb_tx_phyrst_ctl_altera_xcvr_reset_control_161.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_161/sim/altera_xcvr_reset_control.sv" -work tb_tx_phyrst_ctl_altera_xcvr_reset_control_161 -cdslib ./cds_libs/tb_tx_phyrst_ctl_altera_xcvr_reset_control_161.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/../altera_xcvr_reset_control_161/sim/alt_xcvr_reset_counter.sv"    -work tb_tx_phyrst_ctl_altera_xcvr_reset_control_161 -cdslib ./cds_libs/tb_tx_phyrst_ctl_altera_xcvr_reset_control_161.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/tb_tx_phyrst_ctl.v"                                                                                                                                                                              
fi
